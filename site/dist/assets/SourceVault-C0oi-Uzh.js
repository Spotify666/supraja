import{C as e,S as t,_ as n,b as r,g as i,v as a,w as o,x as s,y as c}from"./index-7RccF8KQ.js";var l=o(e(),1),u=`**1. What is Medical Tourism?**
...
`,d=t(),f=35,p=e=>`./slides/slide-${String(e).padStart(2,`0`)}.webp`,m=e=>`./slides/thumb-${String(e).padStart(2,`0`)}.webp`;function h(){let[e,t]=(0,l.useState)(1),[n,o]=(0,l.useState)(!1),u=(0,l.useRef)(null),h=(0,l.useRef)(null),{lite:g}=c(),_=(0,l.useCallback)(e=>t(Math.min(f,Math.max(1,e))),[]);(0,l.useEffect)(()=>{let t=t=>{t.key===`ArrowRight`||t.key===`PageDown`?_(e+1):t.key===`ArrowLeft`||t.key===`PageUp`?_(e-1):t.key===`Home`?_(1):t.key===`End`?_(f):t.key.toLowerCase()===`g`?o(e=>!e):t.key.toLowerCase()===`f`&&v()};return window.addEventListener(`keydown`,t),()=>window.removeEventListener(`keydown`,t)},[e,_]),(0,l.useEffect)(()=>{(h.current?.querySelector(`[data-thumb="${e}"]`))?.scrollIntoView({block:`nearest`,inline:`center`,behavior:g?`auto`:`smooth`})},[e,g]);function v(){let e=u.current;document.fullscreenElement?document.exitFullscreen?.():e?.requestFullscreen?.()}return n?(0,d.jsx)(`div`,{className:`h-full overflow-y-auto rail p-4 sm:p-6`,role:`listbox`,"aria-label":`Jump to slide`,children:(0,d.jsx)(`div`,{className:`grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3`,children:Array.from({length:f},(e,t)=>t+1).map(n=>(0,d.jsxs)(`button`,{type:`button`,onClick:()=>{t(n),o(!1)},className:`focus-ring relative rounded-lg overflow-hidden border-2 transition-colors ${n===e?`border-gold`:`border-transparent hover:border-mist-300`}`,children:[(0,d.jsx)(`img`,{src:m(n),alt:`Slide ${n}`,loading:`lazy`,className:`w-full h-auto block`}),(0,d.jsx)(`span`,{className:`absolute bottom-1 right-1.5 text-[10px] font-semibold text-paper bg-pine-950/80 rounded px-1.5 py-0.5`,children:n})]},n))})}):(0,d.jsxs)(`div`,{className:`h-full flex flex-col`,children:[(0,d.jsxs)(`div`,{ref:u,className:`relative flex-1 min-h-0 grid place-items-center bg-pine-950 select-none`,children:[(0,d.jsx)(s,{mode:`wait`,initial:!1,children:(0,d.jsx)(r.img,{src:p(e),alt:`Board deck, slide ${e} of ${f}`,className:`absolute inset-0 w-full h-full object-contain`,initial:!g&&{opacity:0,x:24},animate:{opacity:1,x:0},exit:g?void 0:{opacity:0,x:-18,transition:{duration:.12}},transition:{duration:.22,ease:a},draggable:!1},e)}),(0,d.jsx)(`button`,{type:`button`,onClick:()=>_(e-1),disabled:e===1,"aria-label":`Previous slide`,className:`focus-ring absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 grid place-items-center w-10 h-10 rounded-full bg-pine-900/80 text-paper disabled:opacity-30 hover:bg-pine-800 transition-colors`,children:(0,d.jsx)(i,{name:`chevronLeft`})}),(0,d.jsx)(`button`,{type:`button`,onClick:()=>_(e+1),disabled:e===f,"aria-label":`Next slide`,className:`focus-ring absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 grid place-items-center w-10 h-10 rounded-full bg-pine-900/80 text-paper disabled:opacity-30 hover:bg-pine-800 transition-colors`,children:(0,d.jsx)(i,{name:`chevronRight`})}),(0,d.jsxs)(`div`,{className:`absolute top-3 right-3 flex items-center gap-2`,children:[(0,d.jsxs)(`span`,{className:`text-xs font-medium text-mist-200 tabular-nums bg-pine-900/80 rounded-md px-2.5 py-1.5`,children:[e,` / `,f]}),(0,d.jsx)(`button`,{type:`button`,onClick:()=>o(!0),"aria-label":`Slide grid (G)`,className:`focus-ring grid place-items-center w-9 h-9 rounded-md bg-pine-900/80 text-paper hover:bg-pine-800 transition-colors`,children:(0,d.jsx)(i,{name:`grid`,size:17})}),(0,d.jsx)(`button`,{type:`button`,onClick:v,"aria-label":`Fullscreen (F)`,className:`focus-ring grid place-items-center w-9 h-9 rounded-md bg-pine-900/80 text-paper hover:bg-pine-800 transition-colors`,children:(0,d.jsx)(i,{name:`expand`,size:17})})]})]}),(0,d.jsx)(`div`,{ref:h,className:`rail shrink-0 flex gap-2 overflow-x-auto px-3 py-2.5 bg-pine-950 border-t border-pine-800`,children:Array.from({length:f},(e,t)=>t+1).map(n=>(0,d.jsx)(`button`,{type:`button`,"data-thumb":n,onClick:()=>t(n),"aria-label":`Slide ${n}`,"aria-current":n===e,className:`focus-ring shrink-0 rounded-md overflow-hidden border-2 transition-all ${n===e?`border-gold opacity-100`:`border-transparent opacity-55 hover:opacity-90`}`,children:(0,d.jsx)(`img`,{src:m(n),alt:``,loading:`lazy`,className:`h-12 w-auto block`})},n))})]})}function g(e,t){let n=[],r=e,i=0;for(;r.length;){let e=r.match(/\*\*(.+?)\*\*|\*(.+?)\*/);if(!e){n.push(r);break}e.index>0&&n.push(r.slice(0,e.index)),e[1]===void 0?n.push((0,d.jsx)(`em`,{children:e[2]},`${t}-${i++}`)):n.push((0,d.jsx)(`strong`,{children:e[1]},`${t}-${i++}`)),r=r.slice(e.index+e[0].length)}return n}function _(e){let t=e.split(`
`),n=[],r=0;for(;r<t.length;){let e=t[r];if(!e.trim()){r++;continue}if(/^#{1,6}\s/.test(e)){let t=e.match(/^#+/)[0].length;n.push({type:`h`,level:t,text:e.replace(/^#+\s*/,``).replace(/[*_]/g,``)}),r++}else if(e.trim().startsWith(`|`)){let e=[];for(;r<t.length&&t[r].trim().startsWith(`|`);){let n=t[r].trim().replace(/^\||\|$/g,``).split(`|`).map(e=>e.trim());n.every(e=>/^[-: ]+$/.test(e))||e.push(n),r++}n.push({type:`table`,rows:e})}else if(/^[*+-]\s/.test(e.trim())){let e=[];for(;r<t.length&&(/^\s*[*+-]\s/.test(t[r])||t[r].trim()&&/^\s{2,}/.test(t[r])&&!t[r].trim().startsWith(`|`));)/^\s*[*+-]\s/.test(t[r])?e.push(t[r].replace(/^\s*[*+-]\s*/,``)):e.length&&(e[e.length-1]+=` `+t[r].trim()),r++;n.push({type:`ul`,items:e})}else n.push({type:`p`,text:e.trim()}),r++}return n}function v(){let e=(0,l.useMemo)(()=>_(u),[]),[t,n]=(0,l.useState)(``),r=(0,l.useRef)(null),i=(0,l.useMemo)(()=>{let t=[];return e.forEach((e,n)=>{let r=e.type===`h`?e.text:e.type===`p`&&/^\*\*\d\.\s.+\*\*$/.test(e.text)?e.text.replace(/\*\*/g,``):null;r&&e.type===`p`?t.push({i:n,text:r}):e.type===`h`&&e.level<=1&&t.push({i:n,text:e.text})}),t},[e]),a=t.trim().toLowerCase(),o=(0,l.useMemo)(()=>{if(!a)return new Set;let t=new Set;return e.forEach((e,n)=>{(e.type===`table`?e.rows.flat().join(` `):e.type===`ul`?e.items.join(` `):e.text||``).toLowerCase().includes(a)&&t.add(n)}),t},[a,e]);function s(e){r.current?.querySelector(`[data-block="${e}"]`)?.scrollIntoView({behavior:`smooth`,block:`start`})}return(0,d.jsxs)(`div`,{className:`h-full flex min-h-0`,children:[(0,d.jsxs)(`aside`,{className:`hidden md:flex flex-col w-64 shrink-0 border-r border-line bg-surface`,children:[(0,d.jsxs)(`div`,{className:`p-3 border-b border-line`,children:[(0,d.jsx)(`input`,{type:`search`,value:t,onChange:e=>n(e.target.value),placeholder:`Search the document…`,"aria-label":`Search the document`,className:`focus-ring w-full text-sm rounded-md border border-line bg-paper px-3 py-2 placeholder:text-muted`}),a&&(0,d.jsxs)(`p`,{className:`text-[11px] text-muted mt-1.5`,children:[o.size,` matching block`,o.size===1?``:`s`,` highlighted`]})]}),(0,d.jsx)(`nav`,{className:`rail overflow-y-auto p-2`,"aria-label":`Document outline`,children:i.map(e=>(0,d.jsx)(`button`,{type:`button`,onClick:()=>s(e.i),className:`focus-ring block w-full text-left text-[13px] leading-snug text-ink hover:bg-mist-100 rounded-md px-2.5 py-2 transition-colors`,children:e.text},e.i))})]}),(0,d.jsx)(`div`,{ref:r,className:`rail flex-1 min-w-0 overflow-y-auto bg-paper`,children:(0,d.jsxs)(`article`,{className:`max-w-2xl mx-auto px-5 sm:px-8 py-8 sm:py-10`,children:[(0,d.jsx)(`p`,{className:`kicker text-pine-600 mb-6`,children:`MVT FINAL · WORKING DOCUMENT · VERBATIM`}),e.map((e,t)=>{let n=o.has(t)?`bg-gold-tint outline outline-1 outline-gold-soft rounded-sm`:``;return e.type===`h`?(0,d.jsx)(`h3`,{"data-block":t,className:`font-display font-semibold text-ink mt-8 mb-3 text-xl leading-snug ${n}`,children:e.text},t):e.type===`table`?(0,d.jsx)(`div`,{"data-block":t,className:`my-5 overflow-x-auto rounded-lg border border-line ${n}`,children:(0,d.jsxs)(`table`,{className:`w-full text-sm border-collapse`,children:[(0,d.jsx)(`thead`,{children:(0,d.jsx)(`tr`,{className:`bg-surface text-left`,children:e.rows[0]?.map((e,t)=>(0,d.jsx)(`th`,{className:`px-3 py-2.5 font-semibold text-pine-950 border-b border-line whitespace-nowrap`,children:e.replace(/\*\*/g,``)},t))})}),(0,d.jsx)(`tbody`,{children:e.rows.slice(1).map((e,n)=>(0,d.jsx)(`tr`,{className:`border-b border-line last:border-0`,children:e.map((e,r)=>(0,d.jsx)(`td`,{className:`px-3 py-2.5 align-top text-ink`,children:g(e,`${t}-${n}-${r}`)},r))},n))})]})},t):e.type===`ul`?(0,d.jsx)(`ul`,{"data-block":t,className:`list-disc pl-5 my-3 space-y-1.5 text-[15px] leading-relaxed text-ink ${n}`,children:e.items.map((e,n)=>(0,d.jsx)(`li`,{children:g(e,`${t}-${n}`)},n))},t):/^\*\*\d\.\s.+\*\*$/.test(e.text)?(0,d.jsx)(`h2`,{"data-block":t,className:`font-display font-semibold text-pine-950 mt-12 first:mt-0 mb-4 text-2xl leading-snug ${n}`,children:e.text.replace(/\*\*/g,``)},t):(0,d.jsx)(`p`,{"data-block":t,className:`my-3 text-[15px] leading-relaxed text-ink ${n}`,children:g(e.text,t)},t)})]})})]})}function y({open:e,onClose:t}){let[a,o]=(0,l.useState)(`deck`),u=(0,l.useRef)(null),{lite:f}=c();return(0,l.useEffect)(()=>{if(!e)return;let n=e=>{e.key===`Escape`&&t()};return window.addEventListener(`keydown`,n),document.body.style.overflow=`hidden`,u.current?.focus(),()=>{window.removeEventListener(`keydown`,n),document.body.style.overflow=``}},[e,t]),(0,d.jsx)(s,{children:e&&(0,d.jsx)(r.div,{className:`fixed inset-0 z-50 bg-pine-950/70 backdrop-blur-sm`,initial:!f&&{opacity:0},animate:{opacity:1},exit:{opacity:0,transition:{duration:.15}},transition:{duration:.25,ease:n},onMouseDown:e=>{e.target===e.currentTarget&&t()},children:(0,d.jsxs)(r.div,{ref:u,role:`dialog`,"aria-modal":`true`,"aria-label":`Source documents`,tabIndex:-1,className:`absolute inset-2 sm:inset-6 lg:inset-10 bg-paper rounded-2xl overflow-hidden flex flex-col shadow-2xl focus:outline-none`,initial:!f&&{opacity:0,y:22,scale:.985},animate:{opacity:1,y:0,scale:1},exit:f?void 0:{opacity:0,y:14,scale:.99,transition:{duration:.16}},transition:{duration:.3,ease:n},children:[(0,d.jsxs)(`div`,{className:`shrink-0 flex items-center justify-between gap-3 px-4 sm:px-6 h-14 border-b border-line bg-surface`,children:[(0,d.jsxs)(`div`,{className:`flex items-center gap-2 min-w-0`,children:[(0,d.jsx)(`p`,{className:`kicker text-pine-600 hidden sm:block whitespace-nowrap`,children:`SOURCE DOCUMENTS`}),(0,d.jsxs)(`div`,{className:`flex rounded-lg bg-mist-100 p-0.5 ml-0 sm:ml-3`,role:`tablist`,"aria-label":`Source document`,children:[(0,d.jsx)(`button`,{type:`button`,role:`tab`,"aria-selected":a===`deck`,onClick:()=>o(`deck`),className:`focus-ring px-3.5 py-1.5 rounded-md text-[13px] font-medium transition-colors ${a===`deck`?`bg-paper text-pine-950 shadow-sm`:`text-muted hover:text-ink`}`,children:`Board Deck`}),(0,d.jsx)(`button`,{type:`button`,role:`tab`,"aria-selected":a===`doc`,onClick:()=>o(`doc`),className:`focus-ring px-3.5 py-1.5 rounded-md text-[13px] font-medium transition-colors ${a===`doc`?`bg-paper text-pine-950 shadow-sm`:`text-muted hover:text-ink`}`,children:`MVT Document`})]})]}),(0,d.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,d.jsx)(`p`,{className:`hidden md:block text-[11px] text-muted`,children:`← → navigate · G grid · F fullscreen · Esc close`}),(0,d.jsx)(`button`,{type:`button`,onClick:t,"aria-label":`Close source documents`,className:`focus-ring grid place-items-center w-9 h-9 rounded-md text-muted hover:text-ink hover:bg-mist-100 transition-colors`,children:(0,d.jsx)(i,{name:`close`,size:18})})]})]}),(0,d.jsx)(`div`,{className:`flex-1 min-h-0`,children:a===`deck`?(0,d.jsx)(h,{}):(0,d.jsx)(v,{})})]})})})}export{y as default};